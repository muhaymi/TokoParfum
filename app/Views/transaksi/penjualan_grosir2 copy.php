            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <button type="button" class="btn btn-primary" onclick="paket()">Beli</button>
...
<script>
    ...
    //     cell9.innerHTML = '<input type="text" class="form-control" name="phg[]" required hidden >';
    ...
    function paket() {
        // Ambil tabel dengan id "example1" dan tambahkan baris baru ke tbody
        var tabel = document.getElementById("example1").getElementsByTagName('tbody')[0];
        var newRow = tabel.insertRow();
        ...
        // Isi sel dengan input form yang diperlukan
        cell1.innerHTML = '<input type="text" class="form-control" name="id_produk[]" placeholder="Masukkan ID Produk" required>';
        cell2.innerHTML = '<input type="text" class="form-control" name="nama_produk[]" placeholder="Masukkan Nama Produk" required>';
        cell3.innerHTML = '<input type="text" class="form-control" name="harwal[]" placeholder="Masukkan Harga Awal" required>';
        cell4.innerHTML = '<input type="text" class="form-control" name="harga_produk[]" placeholder="Masukkan Harga Produk" required>';
        cell5.innerHTML = '<input type="text" class="form-control" name="banyak[]" oninput="hitungHargaTotal(this)" placeholder="Masukkan Banyak" required>';
        cell6.innerHTML = '<input type="number" class="form-control" name="diskon[]" oninput="hitungDiskon(this)" value="0" placeholder="Masukkan Diskon" required>';
        cell7.innerHTML = '<input type="text" class="form-control" name="hartot[]" placeholder="Masukkan Harga Total" required>';
        cell8.innerHTML = '<button type="button" class="btn btn-danger" onclick="hapusBaris(this)"><i class="fas fa-times-circle"></i></button>';
        cell9.innerHTML = '<input type="text" class="form-control" name="phg[]" hidden>';
        cell10.innerHTML = '<input type="text" class="form-control" name="banyak_ml[]" hidden>';
        cell11.innerHTML = '<input type="text" class="form-control" name="hcek[]" hidden>';
    }
    ...
    function hitungHargaTotal(input) {
        ...
        if (pkt) {
            ...
            if (jh == "USD") {
                hpInput.value = parseFloat(pkt.harga) * parseFloat(dlr.harga_rupiah);
            }
        } else {
            hInput.value = lh + ' ' + jh;
            hpInput.value = lh;
            ...
            if (jh == "USD") {
                hpInput.value = parseFloat(lh) * parseFloat(dlr.harga_rupiah);
            }
        }
