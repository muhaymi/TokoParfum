                            ...
                            <tbody>
                                ...
                                <?php foreach ($paket as $t) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <button class="btn btn-primary edit-btn" data-toggle="modal" data-target="#editPaketModal" data-id="<?= $t['id_paket']; ?>" data-namket="<?= $t['nama_paket']; ?>" data-jeket="<?= $t['jenis_paket']; ?>" data-tiket="<?= $t['tipe_paket']; ?>" data-harket="<?= $t['harga_paket']; ?>" data-baml="<?= $t['banyak_ml']; ?>">
                                                    UBAH</button>
                                                <form action="<?= base_url('hapus_paket/' . $t['id_paket']); ?>" method="post"><?= csrf_field() ?>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="<?= base_url('/tambah_paket'); ?>" method="post" enctype="multipart/form-data"><?= csrf_field() ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="hargaPaket" name="harga_paket" required>
                                </div>
                                <div class="form-group">
                                    <label>Banyak ML</label>
                                    <input type="text" class="form-control" id="banyakMl" name="banyak_ml" required>
                                </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="<?= base_url('/edit_paket'); ?>" method="post" enctype="multipart/form-data"><?= csrf_field() ?>
                                ...
                                <div class="form-group">
                                    <label>Harga Paket</label>
                                    <input type="text" class="form-control" id="editHargaPaket" name="harga_paket" required>
                                </div>
                                <div class="form-group">
                                    <label>Banyak ML</label>
                                    <input type="text" class="form-control" id="editBanyakMl" name="banyak_ml" required>
                                </div>
...
<script>
    $(document).ready(function() {
        $(document).on('touchstart click', '.edit-btn', function() {
            ...
            var baket = $(this).data('baket');
            var harket = $(this).data('harket');
            var baml = $(this).data('baml');
            ...
            $('#editBanyakMl').val(baket);
            $('#editHargaPaket').val(harket);
            $('#editBanyakMl').val(baml);
